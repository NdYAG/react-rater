	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_src2.default, { interactive: false, fraction: true, rating: 3.6 })
	          ),
	          _react2.default.createElement(
	            'dt',
	            null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rater = function (_Component) {
	  ...
	  _createClass(Rater, [{
	    ...
	    value: function render() {
	      ...
	      var fraction = _props.fraction;
	      var children = _props.children;

	      var rest = _objectWithoutProperties(_props, ['total', 'limit', 'rating', 'interactive', 'fraction', 'children']);
	      ...
	      var nodes = Array(total).join(',').split(',').map(function (_, i) {
	        var starProps = {
	          isActive: !_this2.state.isRating && rating - i >= 1 ? true : false,
	          isActiveHalf: fraction ? !_this2.state.isRating && rating - i >= 0.5 && rating - i < 1 ? true : false : false,
	...
	Rater.propTypes = {
	  ...
	  fraction: _react.PropTypes.bool,
