...
var _star = __webpack_require__(31);
...
var _LimitedRater = __webpack_require__(32);
  ...
  _createClass(Face, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          willBeActive = _props.willBeActive,
          icon = _props.icon,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_src2.default, { interactive: false, rating: 3.6 })
          ),
          _react2.default.createElement(
            'dt',
            null,
...
var LimitedRater = function (_Component) {
  ...
  function LimitedRater() {
    ...
    return _possibleConstructorReturn(this, (LimitedRater.__proto__ || Object.getPrototypeOf(LimitedRater)).apply(this, arguments));
  }
  ...
  _createClass(LimitedRater, [{
    ...
    value: function render() {
      ...
      var minStars = Array.apply(null, Array(min)).map(function (_, i) {
        return _react2.default.createElement(_src.Star, { isActive: true, isDisabled: true, key: 'min-' + i });
      });
      var maxStars = Array.apply(null, Array(total - max)).map(function (_, i) {
        return _react2.default.createElement(_src.Star, { isActive: false, isDisabled: true, key: 'max' + i });
      });
      return _react2.default.createElement(
        'div',
        { className: 'react-rater' },
        ...
        _react2.default.createElement(_src2.default, { rating: rating - min, total: max - min }),
        _react2.default.createElement(
          'div',
          { style: { display: 'inline-block' } },
          maxStars
